<script src="{{ URL::to('resources/views/theme/assets/js/jquery.min.js') }}"></script>
<script src="{{ URL::to('resources/views/theme/assets/js/jquery.dropotron.min.js') }}"></script>
<script src="{{ URL::to('resources/views/theme/assets/js/jquery.scrolly.min.js') }}"></script>
<script src="{{ URL::to('resources/views/theme/assets/js/jquery.scrollex.min.js') }}"></script>
<script src="{{ URL::to('resources/views/theme/assets/js/browser.min.js') }}"></script>
<script src="{{ URL::to('resources/views/theme/assets/js/breakpoints.min.js') }}"></script>
<script src="{{ URL::to('resources/views/theme/assets/js/util.js') }}"></script>
<script src="{{ URL::to('resources/views/theme/assets/js/main.js') }}"></script>

<script src="{{ URL::to('resources/views/theme/js/jquery.min.js') }}"></script>
<script src="{{ URL::to('resources/views/theme/js/bootstrap.min.js') }}"></script>
<script src="{{ URL::to('resources/views/theme/js/dropdown.js') }}"></script>
...
<script type="text/javascript" src="{{ URL::to('resources/views/theme/countdown/jquery.countdown.js?v=1.0.0.0') }}"></script>
@if(!empty($event_start_time))
<script type="text/javascript">
		$('#example').countdown({
			date: '{{ date("m/d/Y H:i:s", strtotime($event_start_time)) }}',
			offset: -8,
			day: 'Day',
			days: 'Days'
		}, function () {
...
@endif
<!--- back to top --->
<script src="{{ asset('resources/views/theme/backtop/jquery.backTop.min.js') }}"></script>
<script>
            $(document).ready( function() {
                $('#backTop').backTop({
                    'position' : 300,
...
<!--- audio --->
<script src="{{ asset('resources/views/theme/audio/audioplayer.js') }}"></script>
<script>
	$(function() {
				$('audio').audioPlayer();
	});
...
<!-- testimonial --->
<script src="{{ URL::to('resources/views/theme/testimonial/testimonial.js') }}"></script>
<!-- testimonial --->
...
<!---- gallery --->
<script src="{{ asset('resources/views/theme/lightbox/jquery.lightbox.js') }}"></script>
<script>
  // Initiate Lightbox
  $(function() {
    $('.gallery a').lightbox(); 
...
<script type="text/javascript">
    $(document).ready(function() {
	  ...
	  $(this).cPager({
            pageSize: {{ $extrasettings->event_per_page }}, 
            pageid: "event-pager", 
            itemClass: "li-item",
			pageIndex: 1
	...
	$(this).cPager({
            pageSize: {{ $extrasettings->gallery_per_page }}, 
	...
	$(this).cPager({
            pageSize: {{ $extrasettings->pastor_per_page }}, 
            pageid: "pastor-pager", 
            itemClass: "li-item",
			pageIndex: 1
	...
	$(this).cPager({
            pageSize: {{ $extrasettings->sermon_per_page }}, 
            pageid: "sermon-pager", 
            itemClass: "li-item",
			pageIndex: 1
	...
	$(this).cPager({
            pageSize: {{ $extrasettings->testimonial_per_page }}, 
	...
	$(this).cPager({
            pageSize: {{ $extrasettings->blog_per_page }}, 
            pageid: "blog-pager", 
            itemClass: "li-item",
			pageIndex: 1
	...
	$(this).cPager({
            pageSize: {{ $extrasettings->product_per_page }}, 
...
<!-- product -->
<script src="{{ URL::to('resources/views/theme/product/swiper.js') }}"></script>
<script src="{{ asset('resources/views/theme/product/product-tab.js') }}"></script>
<!-- product -->
