                ...
                <div class="page-header float-right">
                    <div class="page-title">
                        <ol class="breadcrumb text-right">
                            <a href="{{ url('/admin/add-event') }}" class="btn btn-success btn-sm"><i class="fa fa-plus"></i> Add Event</a>
                        </ol>
                    </div>
                </div>
            </div>
                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($event['view'] as $event)
                                        <tr>
                                            <td>{{ $no }}</td>
                                            <td>@if($event->event_photo !='')
                                            <img src="{{ url('/') }}/public/storage/events/{{ $event->event_photo }}" alt="{{ $event->event_photo }}" class="image-size">
                                            @else
                                            <img src="{{ url('/') }}/public/img/no-image.jpg" alt="{{ $event->event_photo }}" class="image-size">
                                            @endif
                                            </td>
