                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                           ...
                                           <div class="form-group">
                                                <label for="site_logo" class="control-label mb-1">Slideshow Image (size 1920 x 600) <span class="require">*</span></label>
                                                
                                            <input type="file" id="slide_image" name="slide_image" class="form-control-file"  @if($edit['slide']->slide_image == '') data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" @else data-bvalidator="extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg" @endif>
                                            @if($edit['slide']->slide_image != '') <img  src="{{ url('/') }}/public/storage/slideshow/{{ $edit['slide']->slide_image }}" alt="{{ $edit['slide']->slide_image }}" class="image-size" />@else <img src="{{ url('/') }}/public/img/no-image.jpg" alt="{{ $edit['slide']->slide_image }}"  class="image-size"/>  @endif
                                            </div>                                  
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input id="slide_heading" name="slide_heading" type="text" class="form-control" value="{{ $edit['slide']->slide_heading }}">
                                            </div>                                   
                                            
                                            
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">Sub Heading</label>
                                                <input id="slide_subheading" name="slide_subheading" type="text" class="form-control" value="{{ $edit['slide']->slide_subheading }}">
                                            </div>
