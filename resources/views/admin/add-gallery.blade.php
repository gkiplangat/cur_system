                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       @if($demo_mode == 'on')
                           ...
                           @else
                       <form action="{{ route('admin.add-gallery') }}" method="post" id="setting_form" enctype="multipart/form-data">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                             ...
                                             <div class="form-group">
                                                ...
                                                <input type="file" id="gallery_image" name="gallery_image" class="form-control" data-bvalidator="required,extension[jpg:png:jpeg]" data-bvalidator-msg="Please select file of type .jpg, .png or .jpeg">
                                            </div> 
