                            ...
                            <div class="card-body">
                                <table id="bootstrap-data-table-export" class="table table-striped table-bordered">
                                    ...
                                    @foreach($slideData['slide'] as $slide)
                                        <tr>
                                            <td>{{ $no }}</td>
                                            <td width="200">{{ $slide->slide_heading }} </td>
                                            ...
                                            @else 
                                            <a href="slideshow/{{ $slide->slide_id }}" class="btn btn-danger btn-sm" onClick="return confirm('Are you sure you want to delete?');"><i class="fa fa-trash"></i>&nbsp;Delete</a>@endif</td>
                                        </tr>
