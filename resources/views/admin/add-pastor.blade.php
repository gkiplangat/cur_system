                ...
                <div class="row">
                    ...
                    <div class="col-md-12">
                       @if($demo_mode == 'on')
                           ...
                           @else
                       <form action="{{ route('admin.add-pastor') }}" method="post" id="setting_form" enctype="multipart/form-data">
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                            ...
                                            <div class="form-group">
                                               ...
                                               <input id="pastor_name" name="pastor_name" type="text" class="form-control" data-bvalidator="required">
                                            </div>
                                            
                                             <div class="form-group">
                                                <label for="site_desc" class="control-label mb-1">Short Description<span class="require">*</span></label>
                                                
                                            <textarea id="pastor_short_desc" name="pastor_short_desc" type="text" cols="30" rows="5" class="form-control" data-bvalidator="required,maxlen[120]"></textarea>
                                            </div>
                                            ...
                                            <div class="form-group">
                                                ...
                                                <textarea name="pastor_desc" id="summary-ckeditor" cols="30" rows="5" class="form-control" data-bvalidator="required"></textarea>
                                            ...
                                            <div class="form-group">
                                               ...
                                               <input id="pastor_phone" name="pastor_phone" type="text" class="form-control" data-bvalidator="required">
                                            </div>
                                            
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">Website</label>
                                                
                                                <input name="pastor_website" id="pastor_website" class="form-control" data-bvalidator="url">
                                            </div> 
                                ...
                                <div id="pay-invoice">
                                    <div class="card-body">
                                     ...
                                     <div class="form-group">
                                               ...
                                               <input id="pastor_email" name="pastor_email" type="text" class="form-control" data-bvalidator="required,email">
                                            </div>
                                    ...
                                    <div class="form-group">
                                                ...
                                                <input id="pastor_facebook" name="pastor_facebook" type="text" class="form-control" data-bvalidator="url">
                                            </div>
                                            
                                            
                                            <div class="form-group">
                                                <label for="name" class="control-label mb-1">Twitter Url</label>
                                                <input id="pastor_twitter" name="pastor_twitter" type="text" class="form-control" data-bvalidator="url">
                                            </div>    
                             
                                   <div class="form-group">
                                                <label for="name" class="control-label mb-1">GPlus Url</label>
                                                <input id="pastor_gplus" name="pastor_gplus" type="text" class="form-control" data-bvalidator="url">
                                            </div> 
                                            
                                            
                                    <div class="form-group">
                                                <label for="name" class="control-label mb-1">Youtube Url</label>
                                                <input id="pastor_youtube" name="pastor_youtube" type="text" class="form-control" data-bvalidator="url">
                                            </div>                                            
