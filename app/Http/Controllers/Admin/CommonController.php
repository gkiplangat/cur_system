...
class CommonController extends Controller
{
	...
	{
	   $donateData['view'] = Pages::getdonateData();
	  $data = array('donateData' => $donateData);
	  return view('admin.donation')->with($data);
	}
	
	public function view_donation_delete($id)
	{
	   Pages::deleteDonate($id);
