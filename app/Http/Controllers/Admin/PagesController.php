...
class PagesController extends Controller
{
	...
	public function save_page(Request $request)
	{
		...
		$data = array('page_title' => $page_title, 'page_desc' => $page_desc, 'page_slug' => $page_slug, 'page_status' => $page_status, 'main_menu' => $main_menu, 'menu_order' => $menu_order, 'footer_menu' => $footer_menu);
