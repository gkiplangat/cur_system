...
class BlogController extends Controller
{
  ...
  public function comment_status($status,$comment_id)
  {
	...
	public function posts()
    {
		...
		$comments = Blog::getcountcommentNew();
	...
	public function save_post(Request $request)
	{
		 ...
		 $rules = array(
				...
				'post_title' => ['required',  Rule::unique('post') -> where(function($sql){ $sql->where('post_status','!=','');})],
	...
	public function update_post(Request $request)
	{
	   ...
	   $post_title = $request->input('post_title');
		 ...
		 $rules = array(
				...
				'post_title' => ['required', Rule::unique('post') ->ignore($post_id, 'post_id') -> where(function($sql){ $sql->where('post_status','!=','');})],
