...
class Blog extends Model
{
  ...
  public static function getcommentNews($post_id)
  {
  ...
  public static function getlatestData($slug)
  {

    $value=DB::table('post')->where('post_slug','!=',$slug)->where('post_status','=',1)->orderBy('post_id', 'desc')->take(5)->get(); 
    return $value;
  ...
  public static function getgroupcommentWell()
  {
  ...
  public static function getcountcommentNew()
  {
    ...
    $value=DB::table('post_comment')->orderBy('comment_id', 'desc')->get()->groupBy('post_id'); 
    return $value;
  ...
  public static function viewBlog($take,$order)
  {

    $value=DB::table('post')->where('post_status','=',1)->take($take)->orderBy('post_id', $order)->get(); 
    return $value;
