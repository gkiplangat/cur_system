...
<link rel="stylesheet" type="text/css" href="<?php echo e(URL::to('resources/views/admin/template/font-select/fontselect-alternate.css')); ?>" />
<link rel="stylesheet" href="<?php echo e(URL::to('resources/views/admin/template/color-picker/farbtastic.css')); ?>" type="text/css" /><?php /**PATH C:\xampp\htdocs\my-jesus\resources\views/admin/stylesheet.blade.php ENDPATH**/ ?>